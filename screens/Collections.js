...
function Collections() {
  return (
    <View style={styles.container}>
           ...
           <View style={styles.houses}>
                 <ImageBackground source={require('../assets/bb5cfa9eb601a4ff2973d598823a5b2a0abba598.png')} style={{width:400, height:120,marginLeft: 15, marginTop:10, resizeMode: 'cover',}}> 
