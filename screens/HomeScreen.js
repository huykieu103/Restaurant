        ...
        <View style={styles.categoris}>
            ...
            <View style={styles.categorisImage}>
                <View style={styles.categorisImage1}>
                    <Image source={require('../assets/bb5cfa9eb601a4ff2973d598823a5b2a0abba598.png')} style={styles.Image}/>
        ...
        <View style={styles.houses}>
            ...
            <View style={styles.housesImage1}>
                <View style={{marginLeft:10}}>
                    <Image source={require('../assets/bb5cfa9eb601a4ff2973d598823a5b2a0abba598.png')} style={{width:200, height:200}}/>
